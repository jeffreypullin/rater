...
#include "stanExports_hierarchical_dawid_skene.h"

RCPP_MODULE(stan_fit4hierarchical_dawid_skene_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_hierarchical_dawid_skene")
