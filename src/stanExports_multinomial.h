...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("theta", "K", K);
        validate_non_negative_index("theta", "K", K);
        context__.validate_dims("parameter initialization", "theta", "vector_d", context__.to_vec(K,K));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > theta(K, Eigen::Matrix<double, Eigen::Dynamic, 1>(K));
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("log_theta", "K", K);
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > log_theta(K, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>(K));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                for (int k = 1; k <= K; ++k) {
                    ...
                    stan::model::assign(log_p_z, 
                                ...
                                (get_base1(get_base1(log_p_z, get_base1(ii, n, "ii", 1), "log_p_z", 1), k, "log_p_z", 2) + get_base1(get_base1(log_theta, k, "log_theta", 1), get_base1(y, n, "y", 1), "log_theta", 2)), 
                                "assigning variable log_p_z");
                }
            }
            ...
            current_statement_begin__ = 19;
            size_t log_theta_k_0_max__ = K;
            size_t log_theta_j_1_max__ = K;
            for (size_t k_0__ = 0; k_0__ < log_theta_k_0_max__; ++k_0__) {
                for (size_t j_1__ = 0; j_1__ < log_theta_j_1_max__; ++j_1__) {
                    if (stan::math::is_uninitialized(log_theta[k_0__](j_1__))) {
                        std::stringstream msg__;
                        msg__ << "Undefined transformed parameter: log_theta" << "[" << k_0__ << "]" << "(" << j_1__ << ")";
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            validate_non_negative_index("log_theta", "K", K);
            validate_non_negative_index("log_theta", "K", K);
            std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > log_theta(K, Eigen::Matrix<double, Eigen::Dynamic, 1>(K));
            stan::math::initialize(log_theta, DUMMY_VAR__);
            stan::math::fill(log_theta, DUMMY_VAR__);
            ...
            if (include_tparams__) {
                ...
                for (size_t j_1__ = 0; j_1__ < log_theta_j_1_max__; ++j_1__) {
                    for (size_t k_0__ = 0; k_0__ < log_theta_k_0_max__; ++k_0__) {
                        vars__.push_back(log_theta[k_0__](j_1__));
                    }
                }
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < log_theta_j_1_max__; ++j_1__) {
                for (size_t k_0__ = 0; k_0__ < log_theta_k_0_max__; ++k_0__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "log_theta" << '.' << k_0__ + 1 << '.' << j_1__ + 1;
                    param_names__.push_back(param_name_stream__.str());
                }
            }
        }
